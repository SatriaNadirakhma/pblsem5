...
Route::get("/get-profile", [LetterController::class, "getProfile"])->middleware(
    "auth:sanctum",
);
...
Route::middleware("auth:sanctum")->group(function () {
    ...
    Route::patch("employee/management/{id}", [
        EmployeeManagementController::class,
        "update",
    ]);
    ...
    Route::get("/izin-list", [
        IzinDashboardController::class,
        "izinList",
    ])->middleware("auth:sanctum");
    Route::get("/izin-detail/{id}", [
        IzinDashboardController::class,
        "IzinDetail",
    ])->middleware("auth:sanctum");
    Route::post("/izin-update/{id}", [
        IzinDashboardController::class,
        "updateStatus",
    ])->middleware("auth:sanctum");
    Route::get("/export-approved-letters", [
        IzinDashboardController::class,
        "exportApprovedLetters",
    ])->middleware("auth:sanctum");
